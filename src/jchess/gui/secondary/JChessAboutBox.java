...
public class JChessAboutBox extends JDialog
{
	...
	private void initializeWindow()
	{
		...
		resourceMap = Application.getInstance(JChessApp.class).getContext().getResourceMap(JChessAboutBox.class);
	...
	{
		setLabelContent(appTitleLabel, true, 4, "Application.title", "Application.title");
		setLabelContent(versionLabel, true, 0, "versionLabel.text", "versionLabel");
		setLabelContent(appVersionLabel, false, 0, "Application.version", "appVersionLabel");
		setLabelContent(homepageLabel, true, 0, "homepageLabel.text", "homepageLabel");
		setLabelContent(appHomepageLabel, false, 0, "Application.homepage", "appHomepageLabel");
		setLabelContent(appDescriptionLabel, false, 0, "appDescLabel.text", "appDescLabel");
		
		imageLabel.setIcon(resourceMap.getIcon("imageLabel.icon")); // NOI18N
		imageLabel.setName("imageLabel"); // NOI18N
		
		setLabelContent(vendorLabel1, true, 0, "vendorLabel1.text", "vendorLabel1");
		
		appVendorLabel1.setName("appVendorLabel1"); // NOI18N
		
		setLabelContent(appHomepageLabel1, false, 0, "appHomepageLabel1.text", "appHomepageLabel1");
		setLabelContent(appHomepageLabel2, false, 0, "appHomepageLabel2.text", "appHomepageLabel2");
		setLabelContent(vendorLabel2, true, 0, "vendorLabel2.text", "vendorLabel2");
		setLabelContent(appHomepageLabel3, false, 0, "appHomepageLabel3.text", "appHomepageLabel3");
	}
	        ...
	        String labelName)
	{
		...
		label.setText(resourceMap.getString(resourceName)); // NOI18N

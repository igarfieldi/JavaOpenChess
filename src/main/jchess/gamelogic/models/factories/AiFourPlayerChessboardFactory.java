...
public class AiFourPlayerChessboardFactory implements IBoardFactory
{
	
	private static AiFourPlayerChessboardFactory instance;
	
	public static AiFourPlayerChessboardFactory getInstance()
	{
		if(instance == null)
		{
			instance = new AiFourPlayerChessboardFactory();
		}
		return instance;
	}
